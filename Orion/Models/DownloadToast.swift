...
struct DownloadToastUX {
    static let ToastBackgroundColor = UIColor.main.withAlphaComponent(0.8)
    static let ToastProgressColor = UIColor.main.withAlphaComponent(0.9)
}
...
class DownloadToast: Toast {
    ...
    func createView(_ labelText: String, descriptionText: String) -> UIView {
        ...
        let icon = UIImageView(image: imageNamed("download"))
        ...
        let cancel = UIImageView(image: imageNamed("closeMedium"))
